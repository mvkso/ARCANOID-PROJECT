...
class Game(object):
    ...
    def __init__(self):
        self.tps_max = 15.0
        self.TEMP_COLOR = colors.Colors.GREEN_COLOR
        self.TEMP_COLOR2 = colors.Colors.GREEN_COLOR
        self.level = 1
        self.score = 0
        self.i = 0
        self.temp = 0
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEMOTION:
                    if self.isOver(self.button, mouse_pos):
                        ...
                        self.TEMP_COLOR = colors.Colors.RED_COLOR
                    if self.isOver(self.button2, mouse_pos):
                        self.TEMP_COLOR2 = colors.Colors.GREEN_COLOR
                    else:
                        self.TEMP_COLOR2 = colors.Colors.RED_COLOR
