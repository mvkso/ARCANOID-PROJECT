            ...
            while True:
                ...
                for event in pygame.event.get():
                    ...
                    if event.type == pygame.QUIT:
                        ...
                        if self.button2.bool == True and isOver(self.button2, mpos):
                            return 0
                        elif self.button.bool == True and isOver(self.button, mpos):
                            brick1.bool = True
                            brick2.bool = True
                            brick3.bool = True
                            brick4.bool = True
...
####################LEVEL 4 ##########################
    ...
    ##### LEVEL 6 ##############
        ...
        brick33 = Brick(self, 0, 0)
        brick34 = Brick(self, 0, 0)
        brick35 = Brick(self, 0, 0)
        brick36 = Brick(self, 0, 0)
        brick37 = Brick(self, 0, 0)
        brick38 = Brick(self, 0, 0)
        brick39 = Brick(self, 0, 0)
        brick40 = Brick(self, 0, 0)
        ...
        def level10():
            ...
            brick2.pos = Vector2(70, 144)
            brick3.pos = Vector2(70, 218)
            brick4.pos = Vector2(70, 292)
            brick5.pos = Vector2(70, 366)
            brick6.pos = Vector2(70, 440)
            brick7.pos = Vector2(70, 514)
            brick8.pos = Vector2(70, 588)
            brick9.pos = Vector2(144, 70)
            brick10.pos = Vector2(144, 144)
            brick11.pos = Vector2(144, 218)
            brick12.pos = Vector2(144, 292)
            brick13.pos = Vector2(144, 366)
            brick14.pos = Vector2(144, 440)
            brick15.pos = Vector2(144, 514)
            brick16.pos = Vector2(218, 366)
            brick17.pos = Vector2(292, 366)
            brick18.pos = Vector2(366, 366)
            brick19.pos = Vector2(440, 366)
            brick20.pos = Vector2(514, 366)
            brick21.pos = Vector2(588, 366)
            brick22.pos = Vector2(662, 366)
            brick23.pos = Vector2(736, 366)
            brick24.pos = Vector2(810, 70)
            brick25.pos = Vector2(810, 144)
            brick26.pos = Vector2(810, 218)
            brick27.pos = Vector2(810, 292)
            brick28.pos = Vector2(810, 366)
            brick29.pos = Vector2(810, 440)
            brick30.pos = Vector2(810, 514)
            brick31.pos = Vector2(884, 588)
            brick32.pos = Vector2(884, 514)
            brick33.pos = Vector2(884, 440)
            brick34.pos = Vector2(884, 366)
            brick35.pos = Vector2(884, 292)
            brick36.pos = Vector2(884, 218)
            brick37.pos = Vector2(884, 144)
            brick38.pos = Vector2(884, 70)
            brick39.pos = Vector2(514,70)
            brick40.pos = Vector2(440, 70)
            ...
            while True:
                ...
                if brick32.bool == True:
                    collision(self.ball, brick32)
                if brick33.bool == True:
                    collision(self.ball, brick33)
                if brick34.bool == True:
                    collision(self.ball, brick34)
                if brick35.bool == True:
                    collision(self.ball, brick35)
                if brick36.bool == True:
                    collision(self.ball, brick36)
                if brick37.bool == True:
                    collision(self.ball, brick37)
                if brick38.bool == True:
                    collision(self.ball, brick38)
                if brick39.bool == True:
                    collision(self.ball, brick39)
                if brick40.bool == True:
                    collision(self.ball, brick40)
